    ...
    <section className="py-20 bg-slate-950 border-b border-slate-900" id="learn-section">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-2xl mx-auto mb-16">
          <h2 className="text-3xl sm:text-4xl font-bold font-display text-white tracking-tight" id="learn-section-title">
        ...
        {/* Grid Cards */}
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8" id="learn-grid">
          {learnCards.map((card, idx) => (
            <motion.div
              ...
              className="flex flex-col items-center text-center p-6 bg-slate-900/60 border border-slate-800/80 hover:border-blue-500/50 rounded-2xl shadow-xl hover:shadow-[0_15px_30px_rgba(59,130,246,0.1)] transition-all group"
              id={`learn-card-${card.id}`}
            >
              {/* Icon container */}
              <div className="mb-5 p-4 rounded-full bg-blue-500/10 border border-blue-500/15 group-hover:scale-110 group-hover:bg-blue-500/20 transition-all">
