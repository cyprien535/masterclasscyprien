        ...
        >
          {testimonials.map((t, idx) => (
            <motion.div
              ...
              className="relative rounded-2xl overflow-hidden bg-slate-900 border border-slate-800 hover:border-blue-500/30 transition-all hover:shadow-[0_20px_40px_rgba(59,130,246,0.2)] p-6"
